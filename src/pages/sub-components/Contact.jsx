...
const Contact = () => {
  ...
  const handleMessage = async (e) => {
    ...
    setLoading(true);
    await axios.post(
        "https://mern-portfolio-backend-vilj.onrender.com/api/v1/message/send",
  ...
  return <>
      ...
      <div className="relative mb-8">
        <h1 className="flex gap-4 items-center text-[1.85rem] sm:text-[2.75rem] md:text-[3rem] 
      ...
      <form onSubmit={handleMessage} className="flex flex-col gap-6">
        ...
        <div className="flex justify-end">
          {
            !loading ? <Button type="submit" className="w-full sm:w-52">SEND MESSAGE</Button> : 
            <button
                disabled
                type="button"
