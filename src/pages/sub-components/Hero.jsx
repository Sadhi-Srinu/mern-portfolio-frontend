...
const Hero = () => {
  ...
  return (
    <div  className="w-full">
      ...
      <h1 className="overflow-x-hidden text-[1.3rem] sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.6rem] tracking-[2px] mb-4">
      ...
      <Typewriter words={["FULLSTACK DEVELOPER", "FREELANCER", "MERNSTACK DEVELOPER"]} loop={50} cursor
          typeSpeed={70} deleteSpeed={70} delaySpeed={1000} />
      </h1>  
