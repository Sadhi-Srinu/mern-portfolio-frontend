  ...
  useEffect(() => {
    const getMyProjects = async () => {
      const { data } = await axios.get(
        "https://mern-portfolio-backend-vilj.onrender.com/api/v1/project/getall",
  ...
  return <>
    <div>
      <div className="relative mb-12">
        <h1 className="hidden sm:flex gap-4 items-center text-[2rem] sm:text-[2.75rem] md:text-[3rem] 
          lg:text-[3.8rem] leading-[56px] md:leading-[67px] lg:leading-[90px] tracking-[15px] mx-auto w-fit font-extrabold about-h1"
        ...
        {/* responsive */}
        <h1 className="flex sm:hidden gap-4 items-center text-[2rem] sm:text-[2.75rem] 
